...
public class MapsActivity extends AppCompatActivity {
    ...
    private void setupNavbar() {
        ...
        navMap.setTextColor(redColor);
        for (Drawable d : navMap.getCompoundDrawables()) {
        ...
        findViewById(R.id.navEvents).setOnClickListener(v -> Toast.makeText(this, "Events coming soon", Toast.LENGTH_SHORT).show());
        findViewById(R.id.navForums).setOnClickListener(v -> Toast.makeText(this, "Forums coming soon", Toast.LENGTH_SHORT).show());
        findViewById(R.id.navCovoiturage).setOnClickListener(v -> Toast.makeText(this, "Covoiturage coming soon", Toast.LENGTH_SHORT).show());
    }
